...
import { Button, Container, Card, Col, Row, Badge } from 'reactstrap';
...
export default function VotingApp() {
  ...
  const [items, setItem] = React.useState(defaultArray);
    ...
    <div style={{ textAlign: 'center', padding: '20px 0' }}>
      <Container>
        ...
        <div style={{ padding: '20px 0' }}>
          {items.sort((a, b) => b.vote - a.vote).map(item =>
            <div style={{ padding: '10px 0' }}>
              <Card>
                <Row>
                  ...
                  <Col>
                    <img height='50px' width='auto' src={item.url} />
                  </Col>
                  <Col>
                    <Button color='danger' onClick={() => minusVote(item)}>-</Button>
                    <Button color='success' onClick={() => addVote(item)}>+</Button>
                  </Col>
                </Row>
              </Card>
            </div>
